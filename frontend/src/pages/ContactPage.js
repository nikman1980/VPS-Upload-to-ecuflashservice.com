    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">Have questions? We're here to help you with your ECU tuning needs</p>
        </div>
      </section>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/6797997609" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 font-medium">
                    +679 7997609
                  </a>
                </div>
              </div>
              <p className="text-gray-600 text-sm mb-3">Quick support for urgent orders. Available during business hours.</p>
              <a 
                href="https://wa.me/6797997609" 
                target="_blank" 
