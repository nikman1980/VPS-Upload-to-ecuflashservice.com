...
const DTC_CATEGORIES = {
  dpf: {
    ...
    icon: '🔧',
    codes: ['P2002', 'P2003', 'P242F', 'P244A', 'P244B', 'P2452', 'P2453', 'P2454', 'P2455', 'P2458', 'P2459', 'P2463']
  },
  egr: {
    name: 'EGR (Exhaust Gas Recirculation)',
    icon: '♻️',
    codes: ['P0400', 'P0401', 'P0402', 'P0403', 'P0404', 'P0405', 'P0406', 'P0407', 'P0408', 'P0489', 'P0490', 'P2141', 'P2142', 'P2143', 'P2144', 'P2145']
  },
  adblue: {
    name: 'AdBlue/SCR/DEF',
    icon: '💧',
    codes: ['P20E8', 'P20EE', 'P20EF', 'P2200', 'P2201', 'P2202', 'P2203', 'P2BAD', 'P2BAE', 'P203B', 'P203F', 'P207F', 'P20A1', 'P2047', 'P204F', 'P2048', 'P2049']
  },
  catalyst: {
    name: 'Catalyst/CAT',
    icon: '🌡️',
    codes: ['P0420', 'P0421', 'P0422', 'P0423', 'P0424', 'P0430', 'P0431', 'P0432', 'P0433', 'P0434']
  },
  o2_lambda: {
    name: 'O2/Lambda Sensors',
    icon: '📊',
    codes: ['P0130', 'P0131', 'P0132', 'P0133', 'P0134', 'P0135', 'P0136', 'P0137', 'P0138', 'P0139', 'P0140', 'P0141', 'P0150', 'P0151', 'P0152', 'P0153', 'P0154', 'P0155', 'P0156', 'P0157', 'P0158', 'P0159', 'P0160', 'P0161']
  },
  turbo: {
    name: 'Turbo/Boost',
    icon: '💨',
    codes: ['P0234', 'P0235', 'P0236', 'P0237', 'P0238', 'P0243', 'P0244', 'P0245', 'P0299', 'P0045', 'P0046', 'P0047', 'P0048']
  },
  flaps: {
    name: 'Swirl Flaps/Intake',
    icon: '🌀',
    codes: ['P2004', 'P2005', 'P2006', 'P2007', 'P2008', 'P2009', 'P2014', 'P2015', 'P2016', 'P2017', 'P2070', 'P2071']
  },
  tva: {
    name: 'TVA (Throttle Valve)',
    icon: '🎚️',
    codes: ['P0120', 'P0121', 'P0122', 'P0123', 'P0220', 'P0221', 'P0222', 'P0223', 'P2101', 'P2102', 'P2103', 'P2104', 'P2105', 'P2106', 'P2107', 'P2108', 'P2110', 'P2111', 'P2112', 'P2118', 'P2119']
  },
  nox: {
    name: 'NOx Sensor',
    icon: '☁️',
    codes: ['P2200', 'P2201', 'P2202', 'P2203', 'P2204', 'P2205', 'P2206', 'P2207', 'P2208', 'P2209', 'P229E', 'P229F', 'P22A0', 'P22A1', 'P22A2', 'P22A3']
  },
  readiness: {
    name: 'OBD Readiness',
    icon: '✅',
    codes: ['P1000', 'U0100', 'U0101', 'U0102', 'U0103', 'U0104', 'U0105', 'U0106', 'U0107', 'U0108', 'U0109', 'U0110']
  },
  immo: {
    name: 'Immobilizer (IMMO)',
    icon: '🔐',
    codes: ['P1570', 'P1571', 'P1600', 'P1601', 'P1602', 'P1603', 'P1604', 'P1605', 'P1612', 'P1614', 'P1615', 'P1616', 'P1617']
  },
  speed_limiter: {
    name: 'Speed Limiter (Vmax)',
    icon: '⚡',
    codes: ['P0500', 'P0501', 'P0502', 'P0503', 'P0504', 'P0219', 'P0220', 'P2135']
  },
  start_stop: {
    name: 'Start & Stop System',
    icon: '🔄',
    codes: ['P0560', 'P0562', 'P0563', 'P1A10', 'P1A13', 'P1A14', 'P1A15', 'P1A16', 'P1A17']
  },
  fuel: {
    name: 'Fuel System',
    icon: '⛽',
    codes: ['P0087', 'P0088', 'P0089', 'P0090', 'P0091', 'P0092', 'P0093', 'P0094', 'P0171', 'P0172', 'P0173', 'P0174', 'P0175', 'P0191', 'P0192', 'P0193', 'P0201', 'P0202', 'P0203', 'P0204', 'P0205', 'P0206']
  },
  evap: {
    name: 'EVAP System',
    icon: '💨',
    codes: ['P0440', 'P0441', 'P0442', 'P0443', 'P0444', 'P0445', 'P0446', 'P0447', 'P0448', 'P0449', 'P0450', 'P0451', 'P0452', 'P0453', 'P0455', 'P0456']
  }
};
